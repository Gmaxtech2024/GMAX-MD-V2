...
cmd({
  ...
  try {
    ...
    const _0x2912d9 = path.join(os.tmpdir(), "gmax_md");
    fs.writeFileSync(_0x2912d9, _0x5ee088);
    const _0x5a8c98 = new FormData();
    _0x5a8c98.append("image", fs.createReadStream(_0x2912d9));
    const _0x560c20 = await axios.post("https://api.imgbb.com/1/upload?key=e909ac2cc8d50250c08f176afef0e333", _0x5a8c98, {
      'headers': {
