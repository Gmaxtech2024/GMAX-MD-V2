...
OWNER_NAME: process.env.OWNER_NAME || "Mʀ✰ɢᴍᴀx",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍʀ ɢᴍᴀx*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://i.ibb.co/vQFfbhn/mrgmax.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> Zinda Hun Yar *✦ɢᴍᴀx-ᴍᴅ✦*⚡",
// add alive msg here 
